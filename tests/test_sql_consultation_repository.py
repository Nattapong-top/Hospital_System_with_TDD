...
def test_consultation_repository_should_save_and_get_consultation_success(
    new_consultation,
):
...
def test_consultation_repo_save_and_get_by_consultation_id_should_success(
    new_consultation,
):
...
def test_consultation_repo_update_and_get_by_queue_id_should_success(
    new_consultation, consul_repo, diagnosis, new_queue
):
...
def test_consultation_repo_get_id_return_none_if_not_found(
    new_consultation, consul_repo
):
...
def test_consultation_repo_concurrent_update_should_raise_error(
    new_consultation, consul_repo, diagnosis
):
    consul_repo.save(new_consultation)
