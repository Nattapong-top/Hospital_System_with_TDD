...
def test_api_registrar_patient_duplicate_should_return_same_id(
...
def test_api_registrar_patient_should_fail_when_invalid_nation_id(
    client, valid_patient_payload
):
...
def test_api_new_queue_should_return_success_when_have_patient_id_and_vital_sign(
    client, valid_patient_payload
):
    """
...
def test_api_queue_start_consultation_duplicate_queue_should_fail(
    client, api_new_queues
):
    queue_id = api_new_queues.json()["queue_id"]
...
def test_api_queue_complete_visit_successfully(
