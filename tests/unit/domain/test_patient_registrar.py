...
def test_registrar_patient_when_patient_valid(
    registrar, patient_repo, registered_address, current_address
):
...
def test_registrar_patient_should_handle_when_duplicate_national_id(
    registrar, registered_address, current_address, vital_signs
):
    common_id = NationalID(id="1234567890123")
    new_patient = registrar.register_new_patient(
        national_id=common_id,
...
def test_patient_registrar_should_raise_error_when_national_id_invalid(
    registrar, registered_address, current_address, vital_signs
):
...
def test_patient_registrar_should_handle_repository_failure(
    registered_address, current_address, queue_service, vital_signs
):
...
def test_patient_registrar_should_update_patient_info_through_repository(
